        ...
        <div class="header-top-wrap rel z-5 pt-5 pb-5 rpt-10 rpb-5">
          <div class="container">
            <div class="header-top">
              ...
              <ul>
                <li>
                  <a href="/the-kft-team/donate">
                    <b style="color: white;"> Feed A Needy With Just Rs.11/- | Donate Now </b>
                  </a>
                </li>
                <li>
                  <b style="color: white;">हर कदम आपके साथ</b>
                </li>
              </ul>
            </div>
          </div>
                    ...
                    <ul class="navigation clearfix">
                      <li class="dropdown">
                        ...
                        <ul>
                          ...
                          <li>
                            <a href="/who-we-are/vision-mission">Vision & Mission</a>
                          </li>
                          <li>
                            <a href="/who-we-are/where-we-work">Where We Work</a>
                          </li>
                          <li>
                            <a href="/who-we-are/people-behind-work">People Behind Work</a>
                          </li>
                        </ul>
                      </li>
                      <li class="dropdown">
                        ...
                        <ul>
                          ...
                          <li>
                            <a href="/our-work/livelihood">Livelihood</a>
                          </li>
                          <li>
                            <a href="/our-work/privileged-children">Privileged Children</a>
                          </li>
                          <li>
                            <a href="/our-work/disaster-relief">Disaster Relief</a>
                          </li>
                        </ul>
                      </li>
                      <li class="dropdown">
                        <a href="#">Award & Media</a>
                        <ul>
                          <li>
                            <a href="/award-and-media/award-recognitions">Award & Recognitions</a>
                          </li>
                          <li>
                            <a href="/award-and-media/press-release">Press Release</a>
                          </li>
                          <li>
                            <a href="/award-and-media/online-media">Online Media</a>
                          </li>
                          <li>
                            <a href="/award-and-media/tv-media">TV Media</a>
                          </li>
                          <li>
                            <a href="/award-and-media/gallery">Gallery</a>
                          </li>
                          <li>
                            <a href="/award-and-media/video">Video</a>
                          </li>
                        </ul>
                      </li>
                      <li>
                        <a href="/blog">The KFT Blog</a>
                      </li>
                      <li>
              ...
              <div class="menu-btns">
                <a href="/the-kft-team/donate" class="theme-btn">
                  <span class="btn-text normal">
                    <i class="fas fa-heart"></i> Donate Now </span>
        ...
        <div class="container">
              ...
              <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                  <div class="footer-widget widget_menu wow fadeInUp delay-0-4s">
                    ...
                    <ul>
                      <li>
                        <a href="/award-and-media/award-recognitions">Award</a>
                      </li>
                      <li>
                        <a href="/blog">The KFT Blog</a>
                      </li>
          ...
          <div class="row justify-content-center">
            <div class="col-xl-8 col-lg-10">
              ...
              <form class="newsletter-form wow fadeInUp delay-0-4s" action="SaveSubscribe" method="POST">
                  @csrf
                <input id="email" type="email" placeholder="Enter your email address" name="email" autocomplete="off">
                <button class="theme-btn style-three" type="submit">
                  <span class="btn-text normal">Subscribe <span>Now</span>
                  </span>
                  <span class="btn-text hover">Subscribe <span>Now</span>
                  </span>
                </button>
              </form>
